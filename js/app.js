    ...
    'render': {
        ...
        'message': function (message) {
            ...
            var status =  '<table><tr><td>sys_uptime</td><td>sys_memfree</td><td>nf_conntrack_count</td><td>cpu_usage</td>' +
                ...
                '<td>' + jmsg.sys_uptime +'</td>' +
                '<td>' + jmsg.sys_memfree +'</td>' +
                '<td>' + jmsg.nf_conntrack_count +'</td>' +
                '<td>' + jmsg.cpu_usage +'</td>' +
                '<td>' + jmsg.sys_load +'</td>' +
                '<td>' + jmsg.boad_type +'</td>' +
                '<td>' + jmsg.boad_name +'</td>' +
                '<td>' + jmsg.wifidog_version +'</td>' +
                '<td>' + jmsg.wifidog_uptime +'</td>' +
                '<td>' + jmsg.auth_server +'</td>' +
                '<td>' + jmsg.online_client_count +'</td>' +
                '<td>' + jmsg.active_client_count +'</td></tr></table>'; 
            
            var cl = jmsg.clients;
            var clients = '<table><tr><td>No</td><td>status</td><td>ip</td><td>mac</td><td>name</td><td>first_login</td><td>downloaded</td><td>uploaded</td></tr>'; 
